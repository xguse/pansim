...
# -*- coding: utf-8 -*-
#
# pansim documentation build configuration file, created by
...
def run_apidoc(_):
    ...
    module_path = cur_dir.parent / "pansim"
...
version = pansim.__version__
# The full version, including alpha/beta/rc tags.
release = pansim.__version__
...
latex_documents = [
    ('index', 'pansim.tex',
     u'Pandemic Simulator Documentation',
     u'Gus Dunn', 'manual'),
]
